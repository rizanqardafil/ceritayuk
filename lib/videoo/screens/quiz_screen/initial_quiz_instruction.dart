...
import 'package:shamo/videoo/models/quiz_model.dart';
import 'package:shamo/videoo/screens/quiz_screen/quiz_screen.dart';
      ...
      child: Scaffold(
        body: FutureBuilder(
          ...
          builder: (context, snapshot) {
            ...
            // Json Available,
            int totalQuiz = decodedJsonData["tutorials"]
                ["test${widget.testIndexNumber}"]["length"];
            dynamic listQuiz =
                decodedJsonData["tutorials"]["test${widget.testIndexNumber}"];
