            ...
            child: YoutubePlayerBuilder(
              player: YoutubePlayer(
                ...
                onEnded: (data) async {
                  ...
                  List<String>? courseProgress =
                      preferences.getStringList(widget.courseId);
                  if (courseProgress == null) {
                    print("Something Went Wrong!");
                  } else {
                    double currentCourseProgress =
                        double.parse(courseProgress[0]);
                    double progress =
                        currentCourseProgress + (100 / widget.totalCourseItems);
                    ...
                    preferences.setStringList(
                        widget.courseId, updatedListToBeStored);
                  }
                  showDialog(
                    context: context,
