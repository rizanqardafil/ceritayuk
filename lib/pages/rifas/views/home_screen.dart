import 'package:shamo/pages/rifas/models/flutter_topics_model.dart';
import 'package:shamo/pages/rifas/views/flashcard_screen.dart';
...
class HomePageQuiz extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const Color bgColor3 = Color(0xff21678a); 
    return Scaffold(
