import 'package:shamo/pages/rifas/models/layout_questions_model.dart';
import 'package:shamo/pages/rifas/models/naviagation_questions_model.dart';
import 'package:shamo/pages/rifas/models/widget_questions_model.dart';
import 'package:shamo/pages/rifas/models/state_questions_model.dart';
...
final List<FlutterTopics> flutterTopicsList = [
  FlutterTopics(
    ...
    topicName: "Pencegahan dan Perlindungan",
